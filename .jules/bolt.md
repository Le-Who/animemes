...
## 2024-05-24 - [Animation Loop Performance: Number Formatting]
**Learning:** Calling `.toLocaleString()` inside a `requestAnimationFrame` loop causes implicit locale resolution and garbage collection pressure every frame.
