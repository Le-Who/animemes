...
## 2026-03-24 - [Animation Loop Optimization]
**Learning:** Using toLocaleString() inside requestAnimationFrame creates significant garbage collection overhead. Furthermore, redundantly updating textContent with the same string causes unnecessary browser repaints.
**Action:** Use Intl.NumberFormat instantiated outside the animation loop, and guard textContent updates with a value-change check.
