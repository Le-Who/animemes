...
## 2026-06-04 - Screen Reader Noise from Visual Keyboard Hints
**Learning:** Purely visual keyboard shortcut hints (like arrows or enter symbols) are read aloud by screen readers, creating confusing and disruptive symbol noise for users navigating by keyboard or touch.
**Action:** Always add `aria-hidden="true"` to visual-only keyboard hints to hide them from the accessibility tree.
