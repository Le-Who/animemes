...
## 2026-04-02 - Screen Reader Experience for Decorative Text
**Learning:** Raw decorative text and symbols (like keyboard shortcut hints "←", "→", "↵") are read aloud by screen readers, creating a confusing auditory experience.
**Action:** Always apply `aria-hidden="true"` to decorative symbols or key hints so screen readers skip them.
