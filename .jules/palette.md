...
## 2026-05-21 - Visual Keyboard Hint Noise
**Learning:** Purely visual keyboard shortcut hints (like arrow keys or enter symbols) can create disruptive symbol noise when announced by screen readers.
**Action:** Always add `aria-hidden="true"` to visual keyboard shortcut symbols to prevent screen readers from announcing them, ensuring a cleaner auditory experience.
