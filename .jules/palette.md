...
## 2024-06-15 - Decorative Keyboard Hints & Screen Readers
**Learning:** While visual keyboard hints (like ←, →, ↵) improve discoverability for sighted users, raw symbol characters can be confusing when read aloud by screen readers.
**Action:** Always add `aria-hidden="true"` to visual keyboard hint elements to ensure a clean auditory experience.
