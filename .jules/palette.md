...
## 2026-06-25 - Hiding Decorative Key Hints
**Learning:** Decorative visual hints, such as keyboard shortcut icons (←, →, ↵), should include `aria-hidden="true"` to prevent screen readers from reading them as raw, confusing symbols.
**Action:** Always add `aria-hidden="true"` to decorative visual hints and icons to improve screen reader accessibility.
