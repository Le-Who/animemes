...
## 2026-05-22 - Restoring Focus on Active Element Removal
**Learning:** When hiding or removing an active element (like a "Next" button), keyboard focus drops back to the document body, breaking the navigation flow.
**Action:** Always programmatically restore focus to the next logical interactive element (e.g., using `.focus()`) to maintain seamless keyboard accessibility.
