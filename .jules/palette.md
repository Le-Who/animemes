...
## 2026-05-23 - Screen Reader Experience with Symbols
**Learning:** Decorative symbols used for keyboard hints (like arrows or enter icons) are often read aloud by screen readers as literal characters, creating noise and confusion for users who rely on non-visual navigation.
**Action:** Always add aria-hidden="true" to decorative visual hints or symbols that don't convey essential semantic meaning.
