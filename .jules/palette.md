...
## 2024-05-21 - Visual Keyboard Hints and Screen Readers
**Learning:** Purely visual keyboard shortcut hints (like arrow keys or enter symbols) without `aria-hidden="true"` are announced by screen readers as disruptive symbol noise, degrading the experience.
**Action:** Always add `aria-hidden="true"` to purely visual decorative shortcut symbols so they are ignored by screen readers.
