...
## 2026-06-15 - Hiding Visual Keyboard Hints from Screen Readers
**Learning:** Purely visual keyboard shortcut hints (like arrow keys or enter symbols) can be read out as confusing symbol noise by screen readers, interfering with the primary accessible name of the control.
**Action:** Always add `aria-hidden="true"` to visual keyboard shortcut hints so they are ignored by assistive technologies.
