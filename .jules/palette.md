...
## 2024-05-22 - Screen Reader Handling of Decorative Hints
**Learning:** Screen readers may read decorative visual hints like keyboard shortcut arrows as raw, confusing symbols.
**Action:** Always apply `aria-hidden="true"` to visual shortcut hints to maintain a clean screen reader experience.
