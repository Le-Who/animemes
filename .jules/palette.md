...
## 2026-06-27 - Hiding Keyboard Hints from Screen Readers
**Learning:** Purely visual keyboard shortcut hints (like arrow key symbols or enter icons) inside interactive elements are announced by screen readers as disruptive, out-of-context symbol noise, confusing users who rely on assistive technologies.
**Action:** Always add `aria-hidden="true"` to purely visual keyboard hints to hide them from the accessibility tree, while keeping the main element properly labeled.
