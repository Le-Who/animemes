...
## 2026-05-22 - Hiding Visual Keyboard Hints
**Learning:** Purely visual keyboard shortcut hints (like arrow symbols or enter symbols) are announced by screen readers as disruptive symbol noise.
**Action:** Always add `aria-hidden="true"` to purely visual symbol hints to hide them from the accessibility tree.
