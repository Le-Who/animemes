...
## 2024-05-22 - Hiding Decorative Visual Hints
**Learning:** Decorative visual hints, such as keyboard shortcut icons (←, →, ↵), can cause confusion for screen reader users if read out loud as raw symbols.
**Action:** Always include `aria-hidden="true"` on decorative visual hints to prevent them from polluting the accessibility tree.
