...
## 2026-05-22 - Hiding Decorative Symbols from Screen Readers
**Learning:** Decorative visual hints, such as keyboard shortcut icons (←, →, ↵), are read aloud by screen readers as raw, confusing symbols. This degrades the accessibility of the UI.
**Action:** Always include `aria-hidden="true"` on decorative symbols or keyboard shortcut hints to prevent screen readers from reading them.
