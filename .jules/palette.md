...
## 2026-06-15 - Screen Reader Noise from Symbols
**Learning:** Purely visual keyboard shortcut hints (like arrows or enter symbols) create confusing and disruptive auditory noise for screen reader users when not explicitly hidden from the accessibility tree.
**Action:** Always add `aria-hidden="true"` to purely visual symbol hints to prevent them from being announced by screen readers.
