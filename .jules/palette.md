...
## 2026-05-24 - Hiding Decorative Key Hints
**Learning:** Decorative keyboard shortcut icons (like ←, →, ↵) are read aloud by screen readers as raw, confusing symbols (e.g., "leftwards arrow"), degrading the auditory experience.
**Action:** Always add `aria-hidden="true"` to visual-only keyboard hints to prevent screen reader noise.
