...
## 2024-05-15 - Hide visual keyboard shortcut hints from screen readers
**Learning:** Purely visual keyboard shortcut hints (like arrows or enter symbols) create disruptive symbol noise when announced by screen readers.
**Action:** Always add `aria-hidden="true"` to keyboard shortcut hints that are inside interactive elements.
