...
## 2024-05-21 - Decorative Keyboard Hints Accessibility
**Learning:** Decorative visual hints like keyboard shortcuts (←, →, ↵) are often read aloud by screen readers as confusing raw symbols, degrading the experience.
**Action:** Always add `aria-hidden="true"` to non-essential, purely decorative visual hints.
