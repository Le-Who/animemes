...
## 2024-05-24 - Screen Reader Compatibility for Decorative Symbols
**Learning:** Decorative visual hints, such as keyboard shortcut icons (←, →, ↵), can be read by screen readers as raw, confusing symbols.
**Action:** Include `aria-hidden="true"` on elements containing decorative visual hints to prevent screen readers from reading them.
