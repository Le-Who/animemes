...
## 2026-06-20 - Hiding visual keyboard shortcuts from screen readers
**Learning:** Visual keyboard hints (like arrows or return symbols) are often read aloud by screen readers, creating disruptive symbol noise.
**Action:** Always add `aria-hidden="true"` to purely visual keyboard hint elements to prevent them from interfering with the main accessible text.
