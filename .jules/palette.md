...
## 2026-07-21 - Add keyboard focus states to Next button
**Learning:** Found that custom buttons with complex CSS transitions often lose default browser focus styles, making keyboard navigation difficult for accessibility.
**Action:** Always add explicit `:focus-visible` styles with sufficient outline width and offset for custom buttons.
