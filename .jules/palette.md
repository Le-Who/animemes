...
## 2026-05-19 - Hide visual keyboard shortcuts from screen readers
**Learning:** Purely visual keyboard shortcut hints (like arrows or enter symbols) create disruptive noise when announced by screen readers.
**Action:** Always add `aria-hidden="true"` to keyboard shortcut hints inside interactive elements to improve accessibility.
