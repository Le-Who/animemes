...
## 2026-06-26 - Keyboard Shortcut Screen Reader Noise
**Learning:** Purely visual keyboard shortcut hints (like arrows or return symbols) can be announced by screen readers as disruptive symbol noise, confusing users who rely on assistive technologies.
**Action:** Always add `aria-hidden="true"` to visual keyboard shortcuts that are supplementary to interactive elements.
