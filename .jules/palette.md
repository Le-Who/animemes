...
## 2026-03-29 - Focus Restoration on Hidden Elements
**Learning:** When a focused element (like a 'Next' button) becomes hidden, focus resets to the document body, breaking the keyboard navigation flow.
**Action:** Programmatically restore focus to the primary interactive element (like the next card) to maintain a seamless keyboard loop.
