...
## 2026-03-30 - Focus Management in Dynamic UIs
**Learning:** When hiding elements (like 'Next' buttons) via CSS visibility/opacity or removing them from the DOM, active focus drops to the body, forcing keyboard users to tab through the entire document again.
**Action:** Always programmatically move focus to the next logical interactive element when the currently focused element disappears.
