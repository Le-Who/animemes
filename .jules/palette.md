...
## 2024-05-15 - Hide visual keyboard shortcuts from screen readers
**Learning:** Purely visual keyboard shortcut hints (like arrows or enter symbols) create disruptive symbol noise for screen reader users when read aloud.
**Action:** Always add `aria-hidden="true"` to purely visual keyboard hints within interactive elements.
