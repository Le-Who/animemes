...
## 2026-04-02 - Hiding Decorative Key Hints
**Learning:** Keyboard shortcut icons (←, →, ↵) read by screen readers create a confusing experience, as they are spoken as raw symbols without context.
**Action:** Always add `aria-hidden="true"` to decorative visual hints to keep the accessibility tree clean.
