...
## 2026-06-15 - Dynamic Content & Screen Readers
**Learning:** Visual updates (like game results or new rounds) are invisible to screen readers unless explicitly announced. Using an `aria-live="polite"` region provides essential feedback for blind users without interrupting their flow.
**Action:** Always implement a live region announcer for dynamic single-page application updates.
