...
## 2026-07-04 - Tactile Feedback for Dynamic Elements
**Learning:** Elements that dynamically appear (like the "Next" button after a vote) lack tactile feedback if they only have entry animations. Users expect interactive elements to respond to hover, active, and focus states.
**Action:** Always include `:hover`, `:active`, and explicit `:focus-visible` states for dynamically appearing interactive elements to ensure they feel responsive and are accessible via keyboard.
