...
## 2026-05-22 - Screen Reader Noise from Decorative Hints
**Learning:** Keyboard shortcut hints (like ←, →, ↵) that are purely visual cues add unnecessary noise and confusion for screen reader users, who already interact with the native controls directly.
**Action:** Always add `aria-hidden="true"` to purely visual keyboard hints to keep the accessibility tree clean.
