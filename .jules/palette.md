...
## 2026-06-10 - Hide visual keyboard hints from screen readers
**Learning:** Purely visual keyboard shortcut hints (like arrows or enter symbols) create unnecessary noise for screen reader users and should not be announced.
**Action:** Always add `aria-hidden="true"` to visual keyboard shortcut symbols or hints to prevent them from being announced by assistive technologies.
