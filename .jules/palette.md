...
## 2026-05-22 - Screen Reader Decorative Element Noise
**Learning:** Decorative visual hints, such as keyboard shortcut icons (←, →, ↵), are read aloud by screen readers as raw, out-of-context symbols, creating confusion.
**Action:** Always include `aria-hidden="true"` on decorative key hints or shortcut icons so they enhance visual accessibility without degrading audio accessibility.
