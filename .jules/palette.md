...
## 2026-05-21 - Decorative Symbol Accessibility
**Learning:** Decorative visual hints, such as keyboard shortcut icons (←, →, ↵), can confuse screen reader users if read aloud as raw symbols.
**Action:** Always add `aria-hidden="true"` to decorative text or symbols that provide visual hints but lack contextual meaning for screen readers.
