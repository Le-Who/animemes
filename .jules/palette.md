...
## 2024-05-22 - Hide visual keyboard hints from screen readers
**Learning:** Purely visual keyboard shortcut hints (e.g., arrow keys or enter symbols inside buttons/cards) can be announced as disruptive symbol noise by screen readers.
**Action:** Always add `aria-hidden="true"` to visual keyboard shortcut hints to prevent screen readers from reading them.
