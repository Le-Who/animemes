...
## 2026-07-12 - Missing Focus Styles on Custom Buttons
**Learning:** Custom interactive elements like `.btn` lack `focus-visible` styles, making keyboard navigation difficult to track.
**Action:** Always ensure custom buttons have explicit `:focus-visible` and `:hover` styles for accessibility.
