...
## 2026-02-15 - Dynamic Content Announcements
**Learning:** Visual-only state changes (like score updates or win/loss colors) are completely invisible to screen readers. Adding an aria-live region provides immediate, polite feedback for dynamic content without disrupting the visual design.
**Action:** Always pair dynamic visual updates with a corresponding text update in an aria-live region.
