...
## 2026-04-30 - Decorative Visual Hints
**Learning:** Decorative visual hints, such as keyboard shortcut icons (←, →, ↵), can be read as raw, confusing symbols by screen readers.
**Action:** Always include aria-hidden="true" on decorative text and symbols like keyboard shortcuts.
