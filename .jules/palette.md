...
## 2026-06-16 - Screen Reader Noise from Keyboard Hints
**Learning:** Visual keyboard shortcut hints (like arrows or return symbols) are often announced by screen readers as disruptive symbol noise (e.g., "Leftwards arrow").
**Action:** Always add `aria-hidden="true"` to purely visual shortcut hints to keep the accessibility tree clean.
