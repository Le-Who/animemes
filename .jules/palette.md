...
## 2026-07-06 - Interactive Element States
**Learning:** Custom UI elements like buttons often miss native browser interactive states (hover/active/focus). This makes the UI feel unresponsive and creates accessibility barriers for keyboard users.
**Action:** Always verify and manually style `:hover`, `:active`, and `:focus-visible` states for custom interactive components to ensure tactile feedback and keyboard accessibility.
