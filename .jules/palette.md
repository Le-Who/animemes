...
## 2026-05-21 - Hide Visual Keyboard Hints from Screen Readers
**Learning:** Purely visual keyboard shortcut hints (like "←", "→", or "↵" symbols) can be read aloud by screen readers as disruptive symbol noise, confusing users who rely on assistive technologies.
**Action:** Always add `aria-hidden="true"` to visual keyboard shortcut hints so they are ignored by screen readers.
