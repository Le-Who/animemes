...
## 2026-03-18 - Dynamic Focus Management
**Learning:** When hiding or removing an active element (like a 'Next' button), focus drops to the body, breaking keyboard navigation. Focus must be programmatically restored to maintain accessibility.
**Action:** Use `.focus()` to restore focus to the next logical interactive element when the current focused element is hidden or removed.
