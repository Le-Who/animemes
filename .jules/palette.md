...
## 2026-05-05 - Decorative Keyboard Hints
**Learning:** Raw symbols used for keyboard shortcut hints (like ←, →, ↵) are often read literally by screen readers, creating a confusing auditory experience.
**Action:** Always add `aria-hidden="true"` to decorative keyboard hint elements to hide them from the accessibility tree.
