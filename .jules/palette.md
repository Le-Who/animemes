...
## 2026-06-15 - Decorative Keyboard Hints
**Learning:** Keyboard hints represented by raw symbols (like ←, →, ↵) can be confusing when read aloud by screen readers without proper context.
**Action:** Always add `aria-hidden="true"` to decorative visual hints like keyboard shortcut icons to prevent screen readers from reading them as raw, confusing symbols.
