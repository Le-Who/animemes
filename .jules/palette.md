...
## 2024-07-02 - Missing Focus Indicators on Buttons
**Learning:** Custom UI buttons without `:focus-visible` styles completely disappear from keyboard navigation, even if they have standard hover states.
**Action:** Always add explicit `outline` styles using `:focus-visible` for custom buttons to ensure keyboard accessibility.
