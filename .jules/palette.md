...
## 2024-05-24 - Hide Visual Keyboard Hints from Screen Readers
**Learning:** Purely visual keyboard shortcut hints (like arrow or enter symbols inside buttons or cards) are announced by screen readers as disruptive symbol noise (e.g., "leftward arrow").
**Action:** Always include `aria-hidden="true"` on these visual hint elements to prevent them from interfering with the semantic label or action name.
