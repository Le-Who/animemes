...
## 2026-07-20 - Interactive States for Buttons
**Learning:** Buttons without hover, active, or focus states feel unresponsive and lack tactile feedback, making the UI feel "dead" and hindering keyboard navigation.
**Action:** Always include distinct `:hover`, `:active`, and `:focus-visible` states for interactive elements to provide immediate feedback and accessibility.
