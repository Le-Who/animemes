...
## 2024-05-24 - Missing Interactive States on Dynamic Elements
**Learning:** Custom UI elements like absolutely positioned buttons with transitions often miss default browser focus and hover states, leading to a dead feel for keyboard and mouse users.
**Action:** Always verify `:focus-visible` and `:hover` states on custom-styled buttons, especially those using opacity/visibility toggles.
