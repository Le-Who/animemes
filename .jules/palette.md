...
## 2026-06-23 - Hiding Visual Keyboard Hints from Screen Readers
**Learning:** Purely visual keyboard shortcut hints (like arrows or enter symbols) embedded inside interactive elements will be read aloud by screen readers, creating confusing, disruptive symbol noise for users who do not rely on visual cues.
**Action:** Always add `aria-hidden="true"` to structural or purely visual keyboard hint elements so they are ignored by assistive technologies.
