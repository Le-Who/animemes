...
## 2026-06-18 - Hiding Visual Keyboard Hints
**Learning:** Visual keyboard hints (like '←', '→', or '↵') provide helpful discoverability for sighted users but can be read out loud as disruptive symbol noise by screen readers, interfering with the announcement of the interactive element's actual purpose.
**Action:** Always add `aria-hidden="true"` to visual keyboard shortcut hints (e.g., arrow keys or enter symbols) to prevent screen readers from announcing them as noise.
