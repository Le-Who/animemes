...
**Learning:** Decorative visual hints, such as keyboard shortcut icons (←, →, ↵), are read by screen readers as raw, confusing symbols, degrading the accessibility experience.
**Action:** Always include `aria-hidden="true"` on decorative visual elements or keyboard shortcut hints to prevent screen readers from vocalizing them.
