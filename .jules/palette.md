...
## 2026-04-03 - Decorative Keyboard Hints
**Learning:** Raw text symbols used for keyboard shortcuts (like ←, →, ↵) are read aloud by screen readers (e.g., "leftwards arrow"), creating a confusing auditory experience.
**Action:** Always apply `aria-hidden="true"` to purely visual keyboard hints to ensure screen readers only announce the semantic action.
