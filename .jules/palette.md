...
## 2024-06-01 - Hide keyboard hints from screen readers
**Learning:** Visual keyboard hints (like arrow symbols or enter keys) create confusing noise for screen reader users when read aloud linearly alongside button labels.
**Action:** Always add `aria-hidden="true"` to structural/purely visual keyboard shortcut indicators within interactive elements.
