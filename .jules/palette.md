...
## 2026-04-05 - Decorative Keyboard Hints Accessibility
**Learning:** Decorative visual hints, such as keyboard shortcut icons (←, →, ↵), can cause screen readers to read out raw, confusing symbols.
**Action:** Always include `aria-hidden="true"` on decorative keyboard shortcut indicators to hide them from the accessibility tree.
