...
## 2026-04-25 - Keyboard Hints Accessibility Improvement
**Learning:** Screen readers announce raw symbol characters (like ←, →, ↵) used for keyboard hints, which creates a confusing audio experience for visually impaired users. Visual keyboard shortcuts are decorative/supplementary to the primary action.
**Action:** Always add `aria-hidden="true"` to UI elements that exist solely to display keyboard shortcut hints visually.
