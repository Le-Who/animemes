...
## 2026-05-26 - Disruptive Symbol Noise
**Learning:** Purely visual keyboard shortcut hints (like arrow or enter symbols) are often read aloud by screen readers as disruptive symbol noise ("leftwards arrow"), degrading the experience.
**Action:** Always add `aria-hidden="true"` to visual-only keyboard shortcut hints to keep the accessibility tree clean and focused on semantic meaning.
