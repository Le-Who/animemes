...
## 2026-06-05 - Hiding Purely Visual Keyboard Hints
**Learning:** Purely visual keyboard shortcut hints (like arrow keys or enter symbols) can be disruptive when read by screen readers, adding unnecessary noise.
