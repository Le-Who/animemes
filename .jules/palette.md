...
## 2026-02-06 - Decorative Keyboard Hints & Screen Readers
**Learning:** Decorative visual hints, such as keyboard shortcut icons (←, →, ↵), can cause screen readers to read out raw, confusing symbols, degrading the experience for visually impaired users.
**Action:** Always include `aria-hidden="true"` on non-essential, purely decorative visual keyboard shortcut cues to remove them from the accessibility tree.
