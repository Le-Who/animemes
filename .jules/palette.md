...
## 2024-05-30 - Primary Action Button Affordance
**Learning:** The main action button lacked visual feedback on hover/active and clear keyboard focus states, making it less discoverable and accessible, especially since it only appears after an interaction.
**Action:** Always add explicit `:hover`, `:active`, and `:focus-visible` styles to primary dynamic buttons to ensure interaction confidence and keyboard accessibility.
