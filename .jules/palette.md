...
## 2024-05-25 - Hiding Visual Noise from Screen Readers
**Learning:** Purely visual keyboard shortcut hints (like arrows or enter symbols) are read aloud by screen readers, creating disruptive symbol noise and confusing users relying on assistive tech.
**Action:** Always add `aria-hidden="true"` to visual key hints so they remain visible for sighted users but are skipped by screen readers.
