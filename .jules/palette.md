...
## 2026-05-23 - Keyboard Hint Screen Reader Noise
**Learning:** Purely visual keyboard shortcut hints (like arrow symbols or enter keys inside buttons or cards) are announced by screen readers, causing unnecessary and disruptive symbol noise for users relying on assistive technologies.
**Action:** Always add `aria-hidden="true"` to purely visual keyboard shortcut hints to hide them from the accessibility tree.
