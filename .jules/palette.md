...
## 2024-06-06 - Hide visual keyboard shortcut hints from screen readers
**Learning:** Purely visual keyboard shortcut hints (like arrows or enter symbols) create confusing symbol noise when read by screen readers, degrading accessibility.
**Action:** Always add `aria-hidden="true"` to purely visual keyboard hints to prevent screen readers from announcing them.
