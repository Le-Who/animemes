...
## 2026-05-25 - Screen Reader Noise from Keyboard Hints
**Learning:** Purely visual keyboard shortcut hints (like arrows or return symbols) can cause disruptive "symbol noise" for screen reader users if left exposed in the accessibility tree.
**Action:** Always add `aria-hidden="true"` to visual keyboard shortcuts.
