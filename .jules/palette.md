...
## 2026-05-22 - Keyboard Hints Accessibility
**Learning:** Decorative visual hints, such as keyboard shortcut icons (←, →, ↵), are read out by screen readers as raw, confusing symbols.
**Action:** Always include `aria-hidden="true"` on decorative visual hints to prevent screen readers from reading them.
