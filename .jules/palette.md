...
## 2024-06-19 - Purely visual keyboard shortcut hints noise
**Learning:** Visual keyboard hints (like arrow keys or enter symbols) create disruptive noise for screen reader users when read aloud contextlessly.
**Action:** Always add `aria-hidden="true"` to purely visual keyboard hints to hide them from screen readers while keeping them visible for sighted users.
