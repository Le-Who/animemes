...
## 2026-02-14 - Screen Reader Feedback for Dynamic Content
**Learning:** In a single-page app or game loop, visual updates (new content, win/loss states) are completely invisible to screen reader users unless explicitly announced.
**Action:** Use a live region (`aria-live="polite"`) and a helper function to programmatically announce state changes, ensuring non-visual users stay in sync with the game flow.
