...
## 2026-04-19 - Screen Reader Experience with Decorative Hints
**Learning:** Decorative visual hints like keyboard shortcut icons (←, →, ↵) can be confusing when read by screen readers as raw symbols.
**Action:** Always include `aria-hidden="true"` on decorative text or symbols to prevent screen readers from reading them.
