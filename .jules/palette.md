...
## 2024-06-21 - Hide purely visual keyboard hints from screen readers
**Learning:** Purely visual keyboard shortcut hints (e.g., arrow keys or enter symbols represented by characters like ←, →, ↵) inside interactive elements like cards and buttons cause disruptive symbol noise when announced by screen readers, confusing users who rely on assistive technology.
**Action:** Always add `aria-hidden="true"` to structural elements that display these visual shortcuts, ensuring they are ignored by screen readers while remaining visible to sighted users.
## 2024-06-21 - Hide purely visual keyboard hints from screen readers
**Learning:** Purely visual keyboard shortcut hints (e.g., arrow keys or enter symbols represented by characters like ←, →, ↵) inside interactive elements like cards and buttons cause disruptive symbol noise when announced by screen readers, confusing users who rely on assistive technology.
**Action:** Always add `aria-hidden="true"` to structural elements that display these visual shortcuts, ensuring they are ignored by screen readers while remaining visible to sighted users.
