...
## 2026-05-24 - Hiding Visual Decorative Hints from Screen Readers
**Learning:** Decorative visual elements, such as keyboard shortcut icons (←, →, ↵), can confuse screen reader users if read aloud as raw symbols like "leftwards arrow".
**Action:** Always add `aria-hidden="true"` to decorative symbols to ensure they are skipped by assistive technologies.
