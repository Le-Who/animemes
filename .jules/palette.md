...
## 2026-03-22 - Focus Restoration on Element Removal
**Learning:** When hiding or removing an active element (like a 'Next' button), focus drops to the body, breaking keyboard navigation.
**Action:** Programmatically restore focus (e.g., using `.focus()`) to the next logical interactive element to maintain accessibility.
