...
## 2026-05-28 - Screen Reader Noise from Visual Shortcuts
**Learning:** Purely visual keyboard shortcut hints (like arrow key symbols or return icons) are read aloud by screen readers (e.g., "leftwards arrow"), creating disruptive symbol noise and degrading the accessible experience.
**Action:** Always add `aria-hidden="true"` to elements that only serve as visual keyboard shortcut hints.
