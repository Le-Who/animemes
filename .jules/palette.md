...
## 2024-06-11 - Hide visual keyboard shortcut hints from screen readers
**Learning:** Purely visual keyboard shortcut hints (like arrow keys or enter symbols inside buttons or cards) are announced by screen readers as disruptive symbol noise.
**Action:** Always add aria-hidden="true" to purely visual keyboard hints.
