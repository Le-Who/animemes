...
## 2026-05-22 - Screen Reader Noise from Visual Hints
**Learning:** Purely visual keyboard shortcut hints (like arrow or enter symbols) can become disruptive noise for screen reader users if they are read aloud.
**Action:** Always use `aria-hidden="true"` on purely visual keyboard shortcut elements to prevent them from being announced by assistive technologies.
