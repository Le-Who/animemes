...
## 2026-06-25 - Hiding Visual Keyboard Hints from Screen Readers
**Learning:** Purely visual keyboard shortcut hints (e.g., arrow keys or enter symbols) create disruptive symbol noise when announced by screen readers.
**Action:** Always include `aria-hidden="true"` on purely visual keyboard shortcut hints.
