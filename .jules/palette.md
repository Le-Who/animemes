...
## 2024-02-07 - Hide Visual Keyboard Hints from Screen Readers
**Learning:** Purely visual keyboard shortcut hints (like "←" or "↵" symbols) can be announced by screen readers as disruptive noise or confusing characters, degrading the accessibility experience.
**Action:** Always add `aria-hidden="true"` to structural or decorative elements that serve only as visual keyboard hints.
