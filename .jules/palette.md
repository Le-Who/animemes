...
## 2024-05-24 - Screen Reader Noise from Visual Hints
**Learning:** Purely visual keyboard shortcut hints (like arrows or enter symbols) can create disruptive symbol noise when announced by screen readers, degrading the experience.
**Action:** Always add `aria-hidden="true"` to visual-only keyboard hints that are already implied by the interactive element's role or purpose.
