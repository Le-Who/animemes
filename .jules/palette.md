...
## 2026-07-18 - Interactive States on Call-to-Action Buttons
**Learning:** Primary call-to-action buttons without hover, active, or focus states feel unresponsive and hinder accessibility. Providing immediate visual feedback during interaction significantly improves the perceived responsiveness of the interface.
**Action:** Always ensure interactive elements, especially primary buttons, have distinct `:hover`, `:active`, and `:focus-visible` states defined.
