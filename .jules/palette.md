...
## 2024-05-23 - Decorative Elements and Screen Readers
**Learning:** Decorative visual hints, such as keyboard shortcut icons (←, →, ↵), can be read by screen readers as raw, confusing symbols if not explicitly hidden.
**Action:** Always add `aria-hidden="true"` to decorative visual hints.
