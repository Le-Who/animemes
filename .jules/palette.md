...
## 2026-02-07 - Dynamic State & Screen Readers
**Learning:** Visual-only game updates (like revealing a number or changing colors) are invisible to screen readers without explicit announcements.
**Action:** Use `aria-live="polite"` regions to queue up important status changes (like "Correct!" or "Wrong!") so they are spoken immediately.
