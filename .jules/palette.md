...
## 2026-04-04 - Keyboard Hints Accessibility
**Learning:** Screen readers announce raw unicode symbols used for keyboard hints (like ←, →, ↵) which can be confusing for visually impaired users relying on screen readers.
**Action:** Always add `aria-hidden="true"` to decorative visual hints like keyboard shortcuts so they are ignored by screen readers.
