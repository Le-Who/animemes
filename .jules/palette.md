...
## 2026-03-25 - Dynamic Focus Management
**Learning:** Disappearing UI elements (like a "Next" button) cause the browser to drop focus to `document.body`, disrupting keyboard navigation flow.
**Action:** Always programmatically manage and explicitly restore focus to the next logical interactive element after a UI state change.
