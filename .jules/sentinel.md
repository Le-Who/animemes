...
## 2024-05-24 - Fix API Parameter Injection in update.py
**Vulnerability:** API parameter injection via unsafe f-string URL construction.
**Learning:** Constructing URLs with f-strings and unsanitized data allows HTTP parameter injection, changing API request logic.
**Prevention:** Always use the `params` parameter in HTTP client libraries like `requests` to automatically handle URL encoding and parameter separation.
