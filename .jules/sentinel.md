...
## 2024-05-30 - Prevent URL Parameter Injection
**Vulnerability:** URL parameter injection via f-strings concatenating user input directly into API URLs.
**Learning:** Using f-strings to insert variables into URLs allows malicious input to inject additional query parameters or alter the request structure.
