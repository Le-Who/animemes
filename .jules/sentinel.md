...
## 2024-07-10 - Fix HTTP Parameter Pollution in API requests
**Vulnerability:** URL Injection / Parameter Pollution via f-string URL construction.
**Learning:** External tags were directly concatenated into API requests, which could lead to arbitrary query parameter injection.
**Prevention:** Always use the params dictionary in requests.get() to safely encode external variables instead of manual string concatenation.
