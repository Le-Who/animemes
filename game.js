...
function animateValue(obj, start, end, duration) {
    ...
    // Bolt: Instantiate Intl.NumberFormat once outside the animation loop to avoid per-frame GC overhead
    ...
    const step = (timestamp) => {
        ...
        // Bolt: Guard DOM updates with a value-change check to prevent unnecessary repaints
        if (lastFormattedVal !== formattedVal) {
