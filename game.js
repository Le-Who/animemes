...
// OPTIMIZATION: Reuse Intl.NumberFormat to avoid GC overhead in animation loops
...
function animateValue(obj, start, end, duration) {
    ...
    let lastValue = null; // Track value to avoid redundant DOM updates
    ...
    const step = (timestamp) => {
        ...
        // OPTIMIZATION: Only update DOM if value changed
