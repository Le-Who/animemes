...
function animateValue(obj, start, end, duration) {
    ...
    let lastVal = null;
    // Bolt: Instantiate NumberFormat once outside the loop to avoid implicit locale resolution and GC overhead per frame
    ...
    const step = (timestamp) => {
        ...
        // Bolt: Guard DOM update with a value-change check to prevent unnecessary browser repaints
