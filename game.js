...
function animateValue(obj, start, end, duration) {
    ...
    // Instantiate formatter outside the loop to avoid GC overhead
    ...
    const step = (timestamp) => {
        ...
        const valueStr = formatter.format(currentValue);

        // Bolt: Avoid redundant textContent updates to prevent layout thrashing
