...
function animateValue(obj, start, end, duration) {
    ...
    let lastValue = null;
    // Bolt: Instantiate NumberFormat once outside the loop to avoid GC pressure from .toLocaleString()
    ...
    const step = (timestamp) => {
        ...
        // Bolt: Guard DOM updates to prevent unnecessary layout recalculations
