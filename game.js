...
function animateValue(obj, start, end, duration) {
    ...
    // Bolt: Instantiate Intl.NumberFormat outside the loop to avoid GC pressure and implicit locale resolution overhead
    ...
    const step = (timestamp) => {
        ...
        const currentValue = formatter.format(Math.floor(progress * (end - start) + start));
