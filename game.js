...
// Shared NumberFormat instance to avoid instantiation overhead in animation loops
...
function animateValue(obj, start, end, duration) {
    ...
    const step = (timestamp) => {
        ...
        // Bolt: Reuse formatter and batch DOM updates
        const newVal = numberFormatter.format(Math.floor(progress * (end - start) + start));
        if (obj.textContent !== newVal) {
            obj.textContent = newVal;
        }
