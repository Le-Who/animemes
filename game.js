...
function animateValue(obj, start, end, duration) {
    ...
    // OPTIMIZATION: Instantiate Intl.NumberFormat outside the animation loop
    // to avoid GC overhead and performance penalty of repeated instantiations.
    const formatter = new Intl.NumberFormat();
    let lastValue = null; // Guard for DOM updates
    ...
    const step = (timestamp) => {
        ...
        // OPTIMIZATION: Guard DOM updates to prevent unnecessary browser repaints
