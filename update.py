...
def get_data(tag):
    try:
        ...
        # 🛡️ Sentinel: Securely pass URL parameters via requests params dict to prevent injection
        params = {
        ...
        if '@attributes' in data and 'count' in data['@attributes']:
             ...
             try:
                ...
                # 🛡️ Sentinel: Securely pass tag name via params to prevent injection
