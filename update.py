...
# OPTIMIZATION: Use requests.Session for connection pooling to reduce TCP/TLS overhead
...
def update_database():
    ...
    # OPTIMIZATION: Create a shared requests.Session to reuse TCP connections across multiple API calls
