...
def get_data(tag):
    try:
        ...
        # Security: Use params dictionary to prevent URL parameter injection and ensure proper encoding
        params = {
        ...
        if '@attributes' in data and 'count' in data['@attributes']:
             ...
             try:
                ...
                # Security: Use params dictionary for dynamic values
                tag_params = {'names': tag}
                tag_resp = requests.get(tag_url, params=tag_params, headers=headers, timeout=10)
