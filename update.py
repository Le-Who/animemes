...
def get_data(tag):
    try:
        ...
        # Security enhancement: Use params dictionary to prevent HTTP Parameter Injection
        params = {'tags': f"{tag} sort:score:desc", 'limit': 20}
        ...
        if '@attributes' in data and 'count' in data['@attributes']:
             ...
             try:
                ...
                tag_resp = requests.get(tag_url, params={'names': tag}, headers=headers, timeout=10)
