...
def get_data(tag):
    try:
        ...
        # Security: URL encode tag to prevent injection
        encoded_tag = urllib.parse.quote(tag)
        url = f"{API_URL}&tags={encoded_tag} sort:score:desc&limit=20"
        ...
        if '@attributes' in data and 'count' in data['@attributes']:
             ...
             try:
                tag_url = f"https://gelbooru.com/index.php?page=dapi&s=tag&q=index&json=1&names={encoded_tag}"
