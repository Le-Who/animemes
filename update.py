...
def get_data(tag):
    try:
        ...
        # 🛡️ Fix: Use requests params dict instead of f-string interpolation for safe URL encoding
        ...
        if '@attributes' in data and 'count' in data['@attributes']:
             ...
             try:
                ...
                # 🛡️ Fix: Use requests params dict instead of f-string interpolation for safe URL encoding
                tag_resp = requests.get(tag_base_url, headers=headers, params={'names': tag}, timeout=10)
